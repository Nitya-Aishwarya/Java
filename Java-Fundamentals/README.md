...
Java is called object-oriented because most of the programming in Java is done using classes and objects. Object-oriented programming helps us organize code in a clean and reusable way.
...
This command compiles the file `Main.java` and creates a `.class` file.

In simple words, the JDK is required when we want to develop Java programs.
